...
\AR{
    Thanks for this comment.
    We hope that the revised text shown in response to the previous comment clarifies the mathematical basis for equation 2 as a weighted Monte Carlo estimate.
...
\begin{quote}
    Need to go through and make sure this is done
\end{quote}
