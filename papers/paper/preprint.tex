...
This motivates the question of which of many possible futures futures infrastructure systems and components should be designed for.
...
However, this decision is also subject to assumptions regarding the likelihood and relevance of possible futures.\klaus{Vivek suggests spelling this out in a bit more detail}
