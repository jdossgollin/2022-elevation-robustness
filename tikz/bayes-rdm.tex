...
\begin{tikzpicture}[auto]
    ...
    \node [color=thirds] (s5) at (-4, -3) {\textbf{3) Synthesize}};

    \path [fill=rosso!30] (-6.5, 4.6) -- (-6.5, -1.75) -- (5.5, -1.75) -- (5.5, 4.6) -- cycle;
    \node [rotate=0, color=thirds] (s4) at (4, 3.75) {\textbf{2) Condition}};

    \path [fill=thirds!30] (-6, -1.5) -- (2, -1.5) -- (2, 4.25) -- (-2, 4.25) -- (-2, 1.25) -- (-6, 1.25) -- cycle;
    \node [rotate=45, color=thirds] (s3) at (-1.25, 1.25) {\textbf{1) Explore}};
