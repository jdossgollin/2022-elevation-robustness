...
%DIF ADD papers/earths-future/submission_03.tex   Wed Nov 23 10:44:51 2022
...
\begin{figure}
  ...
  \caption{
    Impact of different subjective probability distributions for local sea level on the implicit weight given to each \gls{rcp} scenario and physical model.
    ...
    In panels (B-D) we show the relationship between these distributions and the 16 probabilistic models (four \gls{rcp} scenarios and four physical representations) available.
    Specifically, (B-D) show the average weight given to each model by each choice for $p_\mathrm{belief}$.
