...
%DIF ADD papers/earths-future/submission_02.tex   Tue Oct  4 11:22:09 2022
...
.
For example, many communities require that new construction be elevated at least }\SI{1}{ft} \DIFadd{above the nominal 100-year flood level \mbox{%DIFAUXCMD
...
\DIFdelbegin \DIFdel{Additionally, local building codes (based on guidance such as \mbox{%DIFAUXCMD
...
.
Among several }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{atlas14_texas:2018,noaa_nonstationary:2022}}\hskip0pt%DIFAUXCMD
.
One }\DIFaddend statistical assumptions these analyses make \DIFdelbegin \DIFdel{that have been recently called into question is stationarity \mbox{%DIFAUXCMD
