...
% TODO: discuss somewhere nearby that creating this low-dimensional projection may be difficult for more complex problems. Refer to R1.
...
% TODO: R1 -- It may be the case that some objectives are not affected by the differences in pbelief between stakeholders and so there is no point in getting tied up trying to pin it down.
...
\begin{table}
  ...
  \end{tabular}
\end{table}
% TODO: R1 -- Table 1: I think at least some detail should be given about the elevation cost and depth-damage functions. I understand they were taken from another work. This would make interpreting the later results easier.
...
\end{figure}
% TODO -- R1: Figure 4b. There is remarkable disagreement between the models of mean sea level rise. It might be worth at least a few sentences commenting on this.
...
% TODO -- R1: Equation 4: it might be helpful to define p here.
...
% TODO -- R1: Line 416: The use of the gamma distribution is quite sensible but is presented without justification. This might be worth just a short sentence on why it was chosen.
...
% TODO: Copy and paste in the new text where we discuss figure 7A. Explain why there is a spike at 0ft and link to cost curves. Note in reponse to R1.
...
% TODO: add another sentence to wrap up explain the implications of the approach for the case study, for example someone elevating a house or issuing guidance / funds for house elevation
...
% TODO -- R1: Figure 8: The y-axis labels on B-D should be more descriptive.
% Suggest to put the curent y label on the title and add y label ''average weight'' or similar
...
% TODO: add a summary sentence about how this analysis might guide decision-making
...
We develop a framework capable of blending iterative, stakeholder-driven exploratory modeling with subjective probabilistic expert assessment. % TODO: cite ViMM Manifesto as an example of how exploratory modeling can be stakeholder-driven
See \cite{helgeson_manifesto:2022}. % ViMM Manifesto
...
We use a didactic case study of house xelevation in the coastal zone to illustrate a method for transparently synthesizing across deep uncertainties.
