...
Many critical infrastructure services around the world are aging \cite{ho_dams:2017}.
Further, anticipated changes to regulation, economics and finance, patterns of population and infrastructure use, and climate challenge their ability to meet their design objectives \cite{doss-gollin_txtreme:2021,doss-gollin_fatalism:2020,chester_reliable:2020}.
...
For example, clear trends in extreme rainfall are apparent across much of southeastern Texas \cite{fagnant_spatiotemporal:2020,nielsen-gammon_txrainfall:2020}, and trends in many other hazards for other locations are consistent with observations \cite<see>[for a comprehensive summary]{ipcc_impacts:2022}.\footnote{Klaus comment TBD}
...
For example, much of the stormwater infrastructure in the United States is inadequate for current climates \cite{lopez-cantu:2018}, let alone future changes.
